...
#SCREENS
Homescrn = pygame.image.load('Homescrn.png')
Homescrn2 = pygame.image.load('Homescrn2.png')
Gamescrn = pygame.image.load('GameScr.png')
Calendarscrn = pygame.image.load('calenderscrn.png')
calcload=pygame.image.load('calcload.png')
booksload=pygame.image.load('BooksLoad.png')
bankload=pygame.image.load('BankLoad.png')
calenload=pygame.image.load('CalendarLoad.png')
musicload=pygame.image.load('MusicLoad.png')
carload=pygame.image.load('CarLoad.png')
hotelload=pygame.image.load('HotelLoad.png')
restload=pygame.image.load('RestLoad.png')
chromeload=pygame.image.load('ChromeLoad.png')
youtload=pygame.image.load('YoutubeLoad.png')
expedload=pygame.image.load('ExpedLoad.png')
mailload=pygame.image.load('MailLoad.png')
guessload=pygame.image.load('GuessLoad.png')
ticload=pygame.image.load('TicLoad.png')
quizload=pygame.image.load('QuizLoad.png')
Mailscrn=pygame.image.load('Mailscrn.png')
...
font3 = pygame.font.SysFont('monospace', 50)
WHITE=(255,255,255)
blue=(0,0,255)
...
def home(location):
    ...
    while running and location=='home':
        ...
        allapps=screen.blit(allapps,(166,606))
        pygame.display.flip()
...
for event in pygame.event.get():
    if event.type==pygame.QUIT:
        ...
        pygame.quit()
        quit()
    if event.type == pygame.MOUSEBUTTONDOWN and event.button == LEFT: # Set the x, y postions of the mouse click
        x, y = event.pos
'''
...
def calculator(location):
    ...
    #subprocess.run("Calculator.py",shell=True,check=True)
...
def calendar(location):
    ...
    pygame.display.flip()
    time.sleep(0.5)
    subprocess.call('calendar.py',shell=True)
...
def chrome(location):
    ...
    pygame.display.flip()
    time.sleep(0.5)
    PyImport_ImportModule(Google.py)
    #subprocess.run("Google.py",shell=True)
...
def mail(location):
    ...
    screen.blit(font3.render("Mail",1,WHITE), (50,190))
...
def music(location):
    ...
    Homebttn=screen.blit(homebttn,(166,688))
    pygame.display.flip()
